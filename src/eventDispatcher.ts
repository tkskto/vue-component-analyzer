...
export class CustomEventListener {
   ...
   * @param priority
   */
  constructor(public type: string, public handler: (e: CustomEvent) => void, public priority: number = 0) {
  }
...
export class CustomEventDispatcher {
  ...
  addEventListener(type: string, callback: (e: CustomEvent) => void, priority = 0): void {
    ...
    this.listeners[type].sort(function (listener1: CustomEventListener, listener2: CustomEventListener) {
